export default function TwitterFeed ({ tweets, searchFilter}) {
    const lowerCaseFilter = searchFilter.toLowerCase()
    
    const filteredTweets = tweets.filter(tweet =>
    tweet.name.toLowerCase().includes(lowerCaseFilter)||
    tweet.handle.toLowerCase().includes(lowerCaseFilter) ||
    tweet.content.toLowerCase().includes(lowerCaseFilter)
)
