...
function RightSide({ imgElon, imgZuck }) {
  return (
...
function CenterSection({ tweets, loggedInUser, createTweetContent, addTweet }) {
  return (
    <main>
      ...
      {tweets.map((tweet) => {
        return <Tweet key={tweets.indexOf(tweet)} tweet={tweet} />;
      })}
    </main>
  );
}
...
export { LeftSide, RightSide, CenterSection };
